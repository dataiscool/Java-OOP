...
public class BnBReservation extends HotelReservation 
{
	...
	public int getCost()
	{ 
		int costBeforeBF = super.getCost(); // we need to use super. here because we are overriding the very same method getCost()
		return costBeforeBF+1000*getNumOfNights(); // add breakfast cost for every night. Note that there is no need for super. since it is inherited.
	}
