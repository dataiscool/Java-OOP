...
public class TrainRide {
	...
	public static void main(String[] args) {
		...
		tNet.travel("3.Hogsmeade", "Scarlet", "3.Snowy Owl", "Purple");
	...
	public static TrainNetwork generateTrainNetwork() {
		...
		TrainLine l1 = new TrainLine(s1, s5, "Scarlet", false);
		...
		TrainStation t6 = new TrainStation("5.Leaky Cauldron");

		t1.setRight(t6);
		t6.setLeft(t1);

		TrainLine l2 = new TrainLine(t1, t6, "Grey", false);
		...
		l2.addStation(t4);
		TrainStation t5 = new TrainStation("Queen's Cross - 3/5");
		l2.addStation(t5);
		...
		TrainLine l3 = new TrainLine(u1, u5, "Purple", false);
		...
		l3.addStation(u4);
		/*TrainStation u5 = new TrainStation("4.Dodric's Hollow");
		l3.addStation(u5);
		TrainStation u6 = new TrainStation("4.Zodric's Hollow");
		l3.addStation(u6);
		TrainStation u7 = new TrainStation("4.Godric's");
		l3.addStation(u7);*/
