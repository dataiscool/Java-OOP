...
public class HashTableTester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tweetTable.values());
        System.out.println(tweetTable.keys());
        ...
        Tweet tweetByAuthor = t.latestTweetByAuthor("USER_a75657c2");
        if (tweetByAuthor == null || !tweetByAuthor.getAuthor().equals("USER_a75657c2") || 
        		!tweetByAuthor.getMessage().equals("So SunChips made a bag that is 100% biodegradeable. It is about damn time somebody did.") || 
        		!tweetByAuthor.getDateAndTime().equals("2010-03-07 21:45:48")) {
        	errors.append("Failer to retrieve the latest tweet by USER_989b85bb\n");
        	//"2010-03-07 21:45:48","So SunChips made a bag that is 100% biodegradeable. It is about damn time somebody did."));
        }
